const POLL=10000;let graph={Nodes:[],Edges:[]},assets=[],devices=[],vulnerabilities=[],tags=[],alerts=[],rules=[],sensors=[],baselines=[],changes=[],events=[],analysisJobs=[],backups=[],settings={},users=[],roles=[],audit=[],incidents=[],assetSecurity=[],dnsObservations=[],smbObservations=[],threatIntelSources=[],threatIntelIndicators=[],reports=[],sensorMetrics=[],healthcheckData=null,assetRiskData=[],correlationRules=[],trends={AlertsByDay:[],NewAssetsByDay:[]},alertStats={total:0,open:0,confirmed:0,approved:0,open_critical:0,open_high:0,open_medium:0,open_low:0,open_info:0};let network,nodesDS,edgesDS;let topologyColourMode='class',purdueTopologyData=null;const topologyPositionCache=new Map();const selected=new Set();
