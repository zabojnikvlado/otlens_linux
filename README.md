...
### Additional passive protocol metadata

The sensor recognizes Kerberos, DCE/RPC, NFS, MSSQL TDS, DTLS, OpenVPN and BitTorrent in addition to the first-wave parsers. See `docs/SECOND_WAVE_PROTOCOL_PARSERS.md`.
